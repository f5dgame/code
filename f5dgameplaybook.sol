...
contract PlayerBook {
    ...
    //TODO:0xF2e0a0B1Cc0Af2B862Aa8fDFD78A137E9d8ad845
    address public affWallet = 0xF2e0a0B1Cc0Af2B862Aa8fDFD78A137E9d8ad845;//0x00aBBff93b10Ece374B14abb70c4e588BA1F799F;
//==============================================================================
//     _| _ _|_ _    _ _ _|_    _   .
//    (_|(_| | (_|  _\(/_ | |_||_)  .
//=============================|================================================    
...
//==============================================================================    
    ...
    modifier onlyDevs() {
        //TODO:
        require(
            msg.sender == 0xEF0aC644ECC638Da9CF2d861ABCBf95F2D1a610F || //0x00aBBff93b10Ece374B14abb70c4e588BA1F799F ||
            msg.sender == 0x60e6C6774fbFC9fdEe0389F525e5920e0f6a789D ,//0x0c46117804260339f8fe2b7f62432Fe287e2bd2b,
